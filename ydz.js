...
if (!COOKIE.yuedongzutokenVal) {
    ...
    yuedongzutokenArr=[ {"imei":"3ddbfea2-773e-9e4f-bf77-fee2ff930c22","store":"0","ini":"29","version":"6","platform":"1","Authorization":"bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..6F4G0VA3Hm3UmBlvzj-RHno0D59S43A3uyk1iYsVKp0","Content-Type":"application/x-www-form-urlencoded","User-Agent":"Dalvik/2.1.0 (Linux; U; Android 10; GLK-AL00 Build/HUAWEIGLK-AL00)","Host":"yuedongzu.yichengw.cn","Connection":"Keep-Alive","Accept-Encoding":"gzip","Content-Length":"0"}]
...
async function all() {
    ...
    for (let i = 0; i < Length; i++) {
        ...
        header = {"imei":"3ddbfea2-773e-9e4f-bf77-fee2ff930c22","store":"0","ini":"29","version":"6","platform":"1","Authorization":"bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..6F4G0VA3Hm3UmBlvzj-RHno0D59S43A3uyk1iYsVKp0","Content-Type":"application/x-www-form-urlencoded","User-Agent":"Dalvik/2.1.0 (Linux; U; Android 10; GLK-AL00 Build/HUAWEIGLK-AL00)","Host":"yuedongzu.yichengw.cn","Connection":"Keep-Alive","Accept-Encoding":"gzip","Content-Length":"0"};
        O = (`${$.name + (i + 1)}🔔`);
        await console.log(`-------------------------\n\n🔔开始运行【${$.name+(i+1)}】`)
