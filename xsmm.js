...
!(async () => {
  if (typeof $request !== "undefined") {
    ...
    xsmmurlArr.push($.getdata('xsmmurl'))
    ...
    xsmmurlArr = ['https://vip.75787.com/app/index.php?i=61&t=0&v=2.0.32&from=wxapp&c=entry&a=wxapp&do=distribute&m=bh_cat&sign=03e7019ab41f933bc14d0a9ad3ff5423&action=index&contr=task&token=6b1125521ec327dd31ce4e6cf880e63f&version=2.0.32']
    xsmmhdArr = [{"Host":"vip.75787.com","Connection":"keep-alive","User-Agent":"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.143 Safari/537.36 MicroMessenger/7.0.9.501 NetType/WIFI MiniProgramEnv/Windows WindowsWechat","content-type":"application/x-www-form-urlencoded","Referer":"https://servicewechat.com/wx37b8d7e9d02bc1d1/2/page-frame.html","Accept-Encoding":"gzip, deflate, br"}]
