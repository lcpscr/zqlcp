...
!(async () => {
  if (typeof $request !== "undefined") {
    ...
    ysmurlArr = ['http://erd.nxhpnx.bar/yunonline/v1/task']
    ysmhdArr = ['{"Host":"erd.nxhpnx.bar","Connection":"keep-alive","Content-Length":"613","Accept":"application/json, text/javascript, */*; q=0.01","Origin":"http://erd.nxhpnx.bar","X-Requested-With":"XMLHttpRequest","User-Agent":"Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2785.116 Safari/537.36 QBCore/4.0.1316.400 QQBrowser/9.0.2524.400 Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/53.0.2875.116 Safari/537.36 NetType/WIFI MicroMessenger/7.0.20.1781(0x6700143B) WindowsWechat","Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","Referer":"http://erd.nxhpnx.%3D%3D?openid=oksnzwa-GBvyfMTfeYETy9sF5TCs","Accept-Encoding":"gzip, deflate","Accept-Language":"zh-CN,zh;q=0.8,en-US;q=0.6,en;q=0.5;q=0.4"}']
    ysm2bodyArr = ['openid=oksnzwa-GBvyfMTfeYETy9sF5TCs&time=296']
    ysmbodyArr = ['secret=%253D&type=read']
    ysmtxArr = ['openid=oksnzwa-GBvyfMTfeYETy9sF5TCs&request_id=fb1f145b7221a02c0704d6727722dc94&ua=0']
